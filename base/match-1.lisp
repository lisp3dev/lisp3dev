...
(lisp3dev.core:define-package :lisp3dev.base.match* (:lisp3dev.base.match)
  (:use :cl)
  (:import/export :lisp3dev.base.unify*)
  (:export
...
(defun lisp3dev.base.unify::%make-match-code% (src ptns)
...
(defun make-matcher (ptn src)
  (cond 
    ...
    ((eq :match (first ptn))
      `(unless ,(lisp3dev.base.unify::%make-match-code% src (cdr ptn))
        (return-from |test| nil)))
        
    ((eq :unify (first ptn))
      `(unless ,(lisp3dev.base.unify::%make-unify-code% src (cdr ptn))
        (return-from |test| nil)))
