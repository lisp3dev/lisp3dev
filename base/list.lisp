...
(lisp3dev.core:define-package :lisp3dev.base.list* (:lisp3dev.base.list)
  (:use :cl)
;  (:import/export :lisp3dev.base.member*)
  (:import/export :lisp3dev.base.text*)
   (:export
