...
(eval-when (:compile-toplevel :load-toplevel :execute)
  (lisp3dev.core.reader:enable-reader))

(lisp3dev.core.init:define-package :lisp3dev.core.pre ()
  (:import/export :lisp3dev.core.test)
