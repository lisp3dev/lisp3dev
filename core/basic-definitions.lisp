...
(defpackage :lisp3dev.mspace
  (:use :cl) ;; <<- これをしないとCCLでエラーがでる。シンボル|@|について競合するとかなんとか…
  (:nicknames :lisp3dev.core.monolithic-name-space))

(lisp3dev.core.init:define-package :lisp3dev.core.basic-definitions ()
  (:use :cl :lisp3dev.core.init :anaphora :cl-annot)

  (:import/export :lisp3dev.core.primary-annotations)
...
(in-package :lisp3dev.core.basic-definitions)
...
(defparameter *<pkg/mspace>* (find-package :lisp3dev.mspace))
