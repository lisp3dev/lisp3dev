...
(lisp3dev.core.init:define-package :lisp3dev.core.common ()
  (:use :cl)
  (:import/export :lisp3dev.core.pre)
                                        ;(:import/export :anaphora :metabang-bind)
  ;(:import/export-from lisp3dev.base.ext #:define-package #:string-concat #:memoized)
  ;(:import/export-from lisp3dev.base.test #:enable-testing #:disable-testing #:precond)
  ...
  (:export 
   ...
   #:in-package
           ...
           #:lisp3dev-core-header

           ;; annotations
           ;#:proc
           ))

(in-package :lisp3dev.core.common)

(defmacro lisp3dev-core-header (&rest ident-extra-readers)
