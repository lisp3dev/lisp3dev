...
;; テスト
(eval-when (:compile-toplevel :load-toplevel :execute) (lisp3dev.core.reader:enable-reader))

(defpackage lisp3dev.core.1-finish-testing
  (:use :cl :lisp3dev.core.test)
  )

(in-package :lisp3dev.core.1-finish-testing)
