...
(defmethod <pkg-exports> ((x package))
  (declare (ignore x))
  (warn "~D is not a lisp3dev:DEFINE-PACKAGE'ed package" (package-name *package*))
  nil)
  ...
  (flet ((pushback-if-needed (x given)
    ...
    (multiple-value-bind (unuse given) (<pkg-exports> *package*)
      ...
      (cond (given
              ...
              (t
               (warn "export*: ~D is not a lisp3dev:DEFINE-PACKAGE'ed package: use CL:EXPORT" (package-name *package*))
               (export sym-or-syms))))))
